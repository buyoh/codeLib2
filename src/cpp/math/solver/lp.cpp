...
int main() {
    ...
    {
        EasyLP lp(6);
        lp.equation.push_back({ 5.0, 1.0, 2.0, 1.0, 0.0, 0.0 }); lp.offset.push_back(20.0);
        lp.equation.push_back({ 2.0, 2.0, 6.0, 0.0, 1.0, 0.0 }); lp.offset.push_back(30.0);
        lp.equation.push_back({ 2.0, 6.0, 4.0, 0.0, 0.0, 1.0 }); lp.offset.push_back(40.0);
        lp.objective = { -1.0, -1.0, -1.0, 0.0, 0.0 };   lp.objective_c = 0.0;

#ifndef SRC_CPP_PREDICTOR_DATASTRUCTURE_LINEAR_LEAST_SQUARE_HPP__
#define SRC_CPP_PREDICTOR_DATASTRUCTURE_LINEAR_LEAST_SQUARE_HPP__
// %=BEGIN DOC
// %title
// 線形式の最小二乗法
//
...
// %=END CODE
#endif  // SRC_CPP_PREDICTOR_DATASTRUCTURE_LINEAR_LEAST_SQUARE_HPP__
